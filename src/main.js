...
import { AOPass, AtmospherePass, GradeOutputShader } from './postfx.js?v=20260926a';
import { Player } from './player.js?v=20260926a';
import { Countryside } from './countryside.js?v=20260926a';
import { Sky } from './sky.js?v=20260926a';
import { Vegetation } from './vegetation.js?v=20260926a';
import { Particles } from './particles.js?v=20260926a';
import { AmbientLife } from './ambient_life.js?v=20260926a';
import { Controls } from './controls.js?v=20260926a';
import { UI } from './ui.js?v=20260926a';
import { NPC } from './npc.js?v=20260926a';
import { Dialogue } from './dialogue.js?v=20260926a';
import { QuestManager } from './quest.js?v=20260926a';
import { AudioManager } from './audio.js?v=20260926a';
import { ProgressionManager } from './progression.js?v=20260926a';
import { ContextActionManager } from './context_actions.js?v=20260926a';
import { InteriorManager } from './interior.js?v=20260926a';
import { SaveManager } from './save.js?v=20260926a';
import { ScentTrail } from './scent.js?v=20260926a';
import { SettingsManager } from './settings.js?v=20260926a';
import { isDiscreteGPU } from './settings.js?v=20260926a';
import { MenuSystem } from './menus.js?v=20260926a';
import { WaypointSystem, Compass } from './waypoints.js?v=20260926a';
import { MusicDirector } from './music.js?v=20260926a';
import { catRimUniforms } from './cat.js?v=20260926a';
import { chunkSceneInstances } from './instanced_chunks.js?v=20260926a';
import { setFoliageDetail } from './foliage.js?v=20260926a';
import { applyCadOverrides } from './cad_overrides.js?v=20260926a';
...
class Game {
  constructor() {
    ...
    // Designs published from cadJS (cad-overrides.json) — name-keyed object
    // overrides applied once the world is fully built. Async, non-blocking.
    applyCadOverrides(this.scene);
    this.score = 0;
