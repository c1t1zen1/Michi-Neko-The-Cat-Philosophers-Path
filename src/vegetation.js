...
import { barkTextures, texturedMaterial } from './textures.js?v=20260911a';
import { createFoliageMaterial, createFoliageDepthMaterial, leafCardTexture, buildCanopy, updateFoliage } from './foliage.js?v=20260911a';
